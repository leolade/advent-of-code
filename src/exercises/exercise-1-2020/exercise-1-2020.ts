import { toNumberArray } from '../../core/input-helpers/to-number-array';
import { Exercise } from '../exercise';
import { exercise12020input } from './exercise-1-2020-input';
...
export class Exercise12020 extends Exercise {
  ...
  numbers: number[] = toNumberArray(exercise12020input);
